...
public class Main {
    ...
    public static boolean checkIsAlreadyInstalled(String host, String port) {
        try {
            ...
            ClusterMasterRemote remoteCode = (ClusterMasterRemote) initialContext.lookup("com/supeream");
            System.out.println("rmi已经安装");
            invokeRmi(remoteCode);
            return true;
        } catch (Exception e) {
            if (e.getMessage() !=null && e.getMessage().contains("com/supeream")) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (cmdLine.hasOption("H")) {
                ...
                formatter.printHelp("com/supeream", options);
                System.exit(0);
            }
